...
import 'package:widmate/features/media/presentation/pages/media_player_page.dart';
import 'dart:io';
...
class _DownloadsPageState extends ConsumerState<DownloadsPage>
  ...
  void _deleteDownload(String id) async {
    await ref.read(downloadControllerProvider.notifier).deleteDownload(id);
  }
  ...
  void _playDownload(DownloadItem download) {
    if (download.filePath != null && download.filePath!.isNotEmpty) {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(
          content: Text('File not found or not yet available.'),
  ...
  void _exportDownload(DownloadItem download) async {
    try {
      if (download.filePath != null &&
          download.filePath!.isNotEmpty &&
          await File(download.filePath!).exists()) {
        ...
        if (directory != null) {
          final newPath = '$directory/${download.title}.${download.fileExtension}';
          await File(download.filePath!).copy(newPath);
          ScaffoldMessenger.of(context).showSnackBar(
            SnackBar(
              content: Text('File exported to $newPath'),
        ...
        ScaffoldMessenger.of(context).showSnackBar(
          const SnackBar(
            content: Text('File not available for export'),
            backgroundColor: Colors.orange,
          ),
        );
      }
    ...
    List<DownloadItem> _getSortedCompletedDownloads(
      ...
      switch (_sortBy) {
        ...
        case 'size':
          ...
          sorted.sort((a, b) => (b.totalBytes ?? 0).compareTo(a.totalBytes ?? 0));
        ...
        appBar: AppBar(
          ...
          actions: [
            ...
            IconButton(
              ...
              onPressed: () => ref.read(downloadControllerProvider.notifier).clearCompletedDownloads(),
          ...
          children: [
            ...
            FilledButton.icon(
              ...
              onPressed: () {
                ...
                // TODO: Navigate to home or add URL page
...
// ...
    ...
    Widget _buildDownloadCard(
      ...
      final isComfortable = layout == 'Comfortable';
      ...
      return Card(
        ...
        child: Padding(
          ...
          padding: EdgeInsets.all(isComfortable ? 16 : 8),
              ...
              Row(
                ...
                children: [
                  ...
                  Container(
                    ...
                    width: isComfortable ? 80 : 60,

                    height: isComfortable ? 45 : 34,
                  ...
                  // Action buttons
                                    ...
                                    if (isActive) ...[
                                      ...
                                      IconButton(
                                        ...
                                        onPressed: () => _playDownload(download), // Play button
                                        ...
                                        onSelected: (value) {
                                          ...
                                          switch (value) {
                                            ...
                                            case 'export':
                                              ...
                                              _exportDownload(download);

                                              break;

                                            case 'delete':

                                              _deleteDownload(download.id);
                                ...
                                if (isActive && download.status == DownloadStatus.downloading) ...[
                                  ...
                                  Row(
                                    ...
                                    children: [
                                      ...
                                      Text(
                                        ...
                                        '${download.getFormattedDownloadedSize()} / ${download.getFormattedFileSize()}',
                                  ...
                                  // Status for paused/failed/queued/canceled
